 ...
 <div id="app">
      <div class="main">
        ...
        <div class="profile">
          <div class="photo">
            <img :src="userImg" alt="котэ" />
          </div>

          <div class="info">
            <p id="userName">Имя: {{userName}}</p>
            <p id="userTelephone">Телефон: {{userTelephone}}</p>
            <p id="userMail">e-mail: {{userMail}}</p>
          </div>
        </div>-->
        ...
        <div class="list">
          ...
          <div class="customModal" v-if="showModalQwestion">
            <div class="customModalTitle">
              Добавление вопроса
              <button class="myBtn closeBtn" @click="closeCustomModal()">
                &times;
              </button>
            </div>
            ...
            <div class="customModalFooter">
              <div class="margin">
                <button class="myBtn" v-on:click="createNewTask()">
                  Сохранить
                </button>
              </div>
            </div>
        ...
        <div class="helloBlock">
          <span>Прощание: </span>
          <textarea id="goodbye" class="goodbye" v-model="goodbyeText">
          </textarea>
        </div>
    ...
    data() {
        return {
          ...
          tasks: [
              ...
              goodbyeText:
                "Спасибо, что помогли нам. Мы с вами обязательно свяжемся.",
