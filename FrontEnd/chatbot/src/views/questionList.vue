 <template>
  <div class="constructor-page">
    <div class="list">
      <h3 class="title">Конструктор чата</h3>
      <b-button @click="create" variant="outline-dark">Добавить вопрос</b-button>
      ...
      <question
        ...
        :question="question"
      />
      <b-button @click="addtoDb" variant="outline-success">Сохранить</b-button>
    </div>
    <b-modal
      @ok="deltext ? deletefromchat(deleteindex) : deletefromqueue(deleteindex)"
      id="deletemodal"
      title="Удаление"
      centered
    >
  ...
  methods: {
    ...
    save() {
      ...
      if (questionbuttons.length && type) {
        ...
        this.questions.push({ text: questiontext, questiontype: questiontype });
      }
      this.resetmodal();
    },
    savechanges(index) {
      ...
      if (!type && questionid == null) {
        this.questions.splice(index, 1, {
          ...
          questiontype: this.question.selected
        });
