<template>
  <div class="registration">
    <b-form @submit.prevent="register" @reset.prevent="onReset" class="registration__form">
      ...
      >
        <b-form-input id="input-1" v-model.lazy="form.FirstName" placeholder="Enter First Name"></b-form-input>
      ...
      >
        <b-form-input id="input-2" v-model.lazy="form.LastName" placeholder="Enter Last Name"></b-form-input>
      ...
      >
        <b-form-input id="input-3" v-model.lazy="form.MiddleName" placeholder="Enter Middle Name"></b-form-input>
